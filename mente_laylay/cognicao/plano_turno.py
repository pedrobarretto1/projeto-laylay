...
from mente_laylay.cognicao.contrato_fala import atualizar_contrato_fala_com_resultados
...
def atualizar_plano_turno(
    ...
    *,
    ...
    if isinstance(novo.get("contrato_fala"), dict):
        novo["contrato_fala"] = atualizar_contrato_fala_com_resultados(
            novo.get("contrato_fala"),
            novo,
        )
    return novo
