...
DEPENDENCIAS_EXECUCAO_INTENCAO = (
    ...
    "falar_com_lipsync", "_falar_resultado_operacional",
    "_enviar_pc_b", "_enviar_pc_b_detalhado", "APPS_MAP",
    "abrir_programa", "fechar_programa",
    "_resolver_referencia_cooperativa",
    "ajustar_volume_sistema", "ajustar_volume_sistema_relativo",
    "obter_volume_sistema", "definir_mudo_sistema",
    "organizar_janelas_robusto", "ativar_tela_cheia_robusta",
    "focar_janela_app", "fechar_janela_por_titulo",
    "_gmail_configurado", "_gmail_falar_resumo_estiloso", "_gmail_buscar_nao_lidos",
