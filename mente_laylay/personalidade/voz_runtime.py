...
class VozRuntime:
    ...
    def flush_fala_proativa(self):
        ...
        if persistentes and comuns:
            # Primeiro cada item passa pela revalidação viva. Só então a
            # entrega persistente separa itens também liberados, sem deixar um
            # briefing bloqueado monopolizar a presença contextual do jogo.
            self._reagendar_itens_proativos(
