...
AGRUPAMENTOS_PERMITIDOS = frozenset({
    "family",
    "validation_group",
...
def validar_por_familias(
    ...
    *,
    ...
    grupos = [
        str(
            (
                item.get(agrupamento_normalizado)
                if agrupamento_normalizado != "family"
    ...
    return {
        ...
        "contrato": {
            ...
            "entidades_inteiras_por_fold": (
                agrupamento_normalizado == "validation_entity_group"
            ),
            "autoriza_execucao": False,
