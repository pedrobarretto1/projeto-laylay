...
|---:|---|---|---:|---|---|
| 001 | passou | arquivos | 2.85s | CREATE_FILE | Cria um arquivo de texto chamado rt1_f.txt e dentro dele escreva ALFA_RT1_F. |
| 002 | passou | arquivos | 0.59s | FILE_READ | Leia o arquivo rt1_f.txt. |
| 003 | passou | iot | 2.65s | IOT_CONTROL | Liga a lâmpada. |
