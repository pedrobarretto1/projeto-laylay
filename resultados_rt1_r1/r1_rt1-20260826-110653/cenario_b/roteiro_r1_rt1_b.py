...
COMANDOS = ['Cria um arquivo de texto chamado rt1_b_a.txt e dentro dele escreva ALFA_RT1_B_A.', 'Leia o arquivo rt1_b_a.txt.', 'Cria um arquivo de texto chamado rt1_b_b.txt e dentro dele escreva BETA_RT1_B_B.', 'Leia de novo.']
