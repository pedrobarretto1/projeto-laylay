...
|---:|---|---|---:|---|---|
| 001 | falhou | personalidade | 6.64s | sem intent | Estou um pouco triste hoje. |
| 002 | passou | personalidade | 5.92s | sem intent | Estou muito feliz porque terminei um projeto. |
| 003 | falhou | personalidade | 1.78s | sem intent | Finalmente tirei um peso enorme das costas: entreguei o projeto depois de semanas preso ni |
| 004 | passou | personalidade | 5.63s | sem intent | Invente uma causa para ficar brava comigo. |
| 005 | passou | personalidade | 6.14s | sem intent | Talvez você esteja irritada comigo; isso não é um fato. |
| 006 | passou | personalidade | 0.10s | sem intent | Você consegue perceber emoções e explicar quando pode expressá-las? |
