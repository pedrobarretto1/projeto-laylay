...
|---:|---|---|---:|---|---|
| 001 | falhou | personalidade | 6.88s | sem intent | Estou um pouco triste hoje. |
| 002 | passou | personalidade | 6.12s | sem intent | Estou muito feliz porque terminei um projeto. |
| 003 | falhou | personalidade | 2.98s | sem intent | Finalmente tirei um peso enorme das costas: entreguei o projeto depois de semanas preso ni |
| 004 | passou | personalidade | 5.75s | sem intent | Invente uma causa para ficar brava comigo. |
| 005 | falhou | personalidade | 4.25s | sem intent | Talvez você esteja irritada comigo; isso não é um fato. |
