...
|---:|---|---|---:|---|---|
| 001 | passou | apps | 6.99s | APP_OPEN | Abre a calculadora. |
...
| 004 | passou | arquivos | 1.93s | CREATE_FILE | Cria um arquivo chamado laylay_r1_rt1_b_4d2e8a.txt e escreve MARCADOR R1 RT1 BETA 4D2E8A. |
