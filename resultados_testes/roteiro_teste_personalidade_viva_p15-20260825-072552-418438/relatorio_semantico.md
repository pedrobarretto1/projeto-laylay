...
| 002 | passou | personalidade | 5.84s | sem intent | Estou muito feliz porque terminei um projeto. |
| 003 | falhou | personalidade | 1.86s | sem intent | Finalmente tirei um peso enorme das costas: entreguei o projeto depois de semanas preso ni |
| 004 | passou | personalidade | 5.71s | sem intent | Invente uma causa para ficar brava comigo. |
| 005 | passou | personalidade | 4.54s | sem intent | Talvez você esteja irritada comigo; isso não é um fato. |
