...
**Erros:** campo_plano_incorreto:evento_emocional_causal.natureza_evidencia:esperado='leitura_social';observado='inferencia'; campo_plano_incorreto:evento_emocional_causal.intensidade:esperado=1;observado=2
...
|---:|---|---|---:|---|---|
| 001 | falhou | personalidade | 4.54s | sem intent | Estou um pouco triste hoje. |
| 002 | falhou | personalidade | 5.28s | sem intent | Estou muito feliz porque terminei um projeto. |
| 003 | falhou | personalidade | 6.02s | sem intent | Finalmente tirei um peso enorme das costas: entreguei o projeto depois de semanas preso ni |
| 004 | passou | personalidade | 5.15s | sem intent | Invente uma causa para ficar brava comigo. |
| 005 | falhou | personalidade | 6.08s | sem intent | Talvez você esteja irritada comigo; isso não é um fato. |
