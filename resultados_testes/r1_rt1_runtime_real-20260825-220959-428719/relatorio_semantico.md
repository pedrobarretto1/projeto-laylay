...
|---:|---|---|---:|---|---|
| 001 | passou | apps | 5.14s | APP_OPEN | Abre a calculadora. |
| 002 | passou | arquivos | 2.75s | CREATE_FILE | Cria um arquivo chamado laylay_r1_rt1_a_7f9c2d.txt e escreve MARCADOR R1 RT1 ALFA 7F9C2D. |
| 003 | passou | arquivos | 0.12s | FILE_READ | Leia o laylay_r1_rt1_a_7f9c2d.txt. |
| 004 | passou | arquivos | 2.76s | CREATE_FILE | Cria um arquivo chamado laylay_r1_rt1_b_4d2e8a.txt e escreve MARCADOR R1 RT1 BETA 4D2E8A. |
