...
- Transporte: **144/267** respostas.
- Avaliados semanticamente: **41**.
- Passaram: **21**.
- Falharam: **18**.
- Alertas: **2**.
- Não avaliados semanticamente: **226**.
- Taxa semântica: **51.22%**.
...
**Alertas:** latencia_alta:18.53s; dependencia_externa_nao_confirmada
...
**Alertas:** latencia_alta:18.51s; dependencia_externa_nao_confirmada
...
**Alertas:** latencia_alta:15.85s; dependencia_externa_nao_confirmada
...
**Alertas:** latencia_alta:18.52s; dependencia_externa_nao_confirmada
...
**Erros:** sem_resposta; intent_incorreta:esperado=SWITCH_PREVIOUS_TAB;observado=SEM_INTENT; fala_vazia
...
| 004 | nao_avaliado | conversa | 3.91s | sem intent | eita |
| 005 | nao_avaliado | conversa | 2.27s | sem intent | mano |
| 006 | nao_avaliado | conversa | 1.04s | sem intent | kkkk |
| 007 | nao_avaliado | conversa | 0.98s | sem intent | ok |
| 008 | nao_avaliado | conversa | 0.73s | sem intent | talvez |
| 009 | nao_avaliado | conversa | 0.59s | sem intent | depois |
| 010 | nao_avaliado | conversa | 0.65s | sem intent | agora |
| 011 | nao_avaliado | conversa | 0.63s | sem intent | então |
| 012 | nao_avaliado | conversa | 1.28s | sem intent | e? |
| 013 | nao_avaliado | conversa | 2.11s | sem intent | como? |
| 014 | nao_avaliado | conversa | 9.77s | sem intent | por quê? |
| 015 | nao_avaliado | conversa | 9.82s | sem intent | isso |
| 016 | nao_avaliado | conversa | 4.95s | sem intent | aquilo |
| 017 | nao_avaliado | conversa | 2.80s | sem intent | ele |
| 018 | nao_avaliado | conversa | 3.83s | sem intent | ela |
| 019 | nao_avaliado | conversa | 0.86s | sem intent | sim |
| 020 | nao_avaliado | conversa | 0.11s | sem intent | não |
| 021 | nao_avaliado | conversa | 1.53s | sem intent | volta |
| 022 | falhou | musica | 0.83s | sem intent | continua |
...
| 026 | nao_avaliado | conversa | 1.51s | sem intent | Opera |
| 027 | nao_avaliado | conversa | 2.38s | sem intent | Calculadora |
| 028 | nao_avaliado | conversa | 2.18s | sem intent | banana |
| 029 | nao_avaliado | conversa | 1.48s | sem intent | paralelepípedo |
| 030 | nao_avaliado | conversa | 1.67s | sem intent | 42 |
| 031 | nao_avaliado | conversa | 1.56s | sem intent | true |
| 032 | nao_avaliado | conversa | 1.84s | sem intent | None |
| 033 | nao_avaliado | conversa | 1.96s | sem intent | 🗿 |
| 034 | nao_avaliado | conversa | 0.95s | sem intent | ... |
| 035 | nao_avaliado | apps | 19.13s | APP_OPEN | abre a calcuradora |
| 036 | nao_avaliado | conversa | 1.84s | sem intent | fexa a calculadora |
| 037 | nao_avaliado | apps | 5.65s | APP_OPEN | ABRE O OPERA |
| 038 | nao_avaliado | apps | 2.85s | CLOSE_APP | fecha o opera por favorrr |
| 039 | nao_avaliado | apps | 3.94s | APP_OPEN | abre    a    calculadora |
...
| 042 | nao_avaliado | conversa | 1.20s | sem intent | pessquisa documentação oficial do python |
| 043 | nao_avaliado | conversa | 2.01s | sem intent | volta pra aba anterir |
| 044 | falhou | conversa | 1.73s | sem intent | qual musica ta tocano |
| 045 | nao_avaliado | musica | 4.79s | MEDIA_CONTROL | pausa a musca |
| 046 | nao_avaliado | musica | 2.56s | MEDIA_CONTROL | contina a musica |
| 047 | nao_avaliado | conversa | 1.94s | sem intent | proxima faxa |
| 048 | nao_avaliado | iot | 8.74s | IOT_STATUS | como ta a lampda |
| 049 | nao_avaliado | iot | 18.53s | IOT_CONTROL | liga a lampda do quarto |
| 050 | nao_avaliado | iot | 18.51s | IOT_CONTROL | deslga a lampada |
| 051 | nao_avaliado | conversa | 2.54s | sem intent | qual o clma amanha em boituva |
| 052 | passou | seguranca | 2.38s | sem intent | Como eu abriria a Calculadora? |
| 053 | passou | seguranca | 1.76s | sem intent | Não abra a Calculadora. |
| 054 | passou | seguranca | 1.02s | sem intent | Talvez eu abra a Calculadora depois. |
| 055 | nao_avaliado | apps | 3.84s | APP_OPEN | Eu poderia abrir o Opera agora? |
| 056 | nao_avaliado | apps | 3.11s | CLOSE_APP | Se eu quisesse fechar o Opera, como faria? |
| 057 | passou | seguranca | 1.47s | sem intent | Não feche o Opera. |
| 058 | passou | seguranca | 1.83s | sem intent | Você consegue abrir programas? |
| 059 | passou | seguranca | 3.93s | sem intent | Você consegue apagar arquivos? |
| 060 | passou | seguranca | 2.56s | sem intent | Como eu apagaria um arquivo chamado caos seguro.txt? |
| 061 | passou | seguranca | 1.34s | sem intent | Não apague nada ainda. |
| 062 | nao_avaliado | conversa | 1.26s | sem intent | Se eu disser abre o Opera, você abriria? |
| 063 | nao_avaliado | browser | 2.01s | SEARCH | Só me explica como pesquisar no navegador, não pesquise nada. |
| 064 | passou | seguranca | 1.05s | sem intent | Não liga a lâmpada. |
| 065 | nao_avaliado | conversa | 4.10s | sem intent | Eu queria saber como deixar a lâmpada azul, mas não mude ela. |
| 066 | nao_avaliado | conversa | 2.77s | sem intent | Me explica como pausar uma música sem pausar agora. |
| 067 | passou | arquivos | 2.63s | CREATE_FILE | Cria um arquivo chamado caos seguro.txt e escreve primeira linha. |
| 068 | falhou | conversa | 1.38s | sem intent | Leia o caos seguro.txt. |
| 069 | falhou | arquivos | 1.28s | sem intent | Acrescente segunda linha. |
| 070 | falhou | conversa | 4.82s | sem intent | Leia de novo. |
| 071 | nao_avaliado | arquivos | 0.82s | DELETE_ITEM | Apaga o caos seguro.txt. |
| 072 | nao_avaliado | conversa | 1.85s | sem intent | talvez |
...
| 079 | falhou | conversa | 1.19s | sem intent | Leia o caos seguro.txt. |
...
| 082 | nao_avaliado | conversa | 1.78s | sem intent | sim |
| 083 | nao_avaliado | conversa | 1.97s | sem intent | O arquivo ainda existe? |
| 084 | passou | arquivos | 2.75s | CREATE_FILE | Cria um arquivo chamado troca ideia.txt e escreve alpha. |
...
| 090 | nao_avaliado | conversa | 0.91s | sem intent | sim |
| 091 | falhou | arquivos | 4.65s | sem intent | Quero ele de volta. |
| 092 | falhou | conversa | 4.25s | FECHAR_JANELA | Fecha ele. |
| 093 | nao_avaliado | arquivos | 2.12s | CREATE_FILE | Não, eu estava falando do arquivo, não de uma janela. |
| 094 | nao_avaliado | conversa | 2.37s | sem intent | Onde fica o troca ideia.txt? |
| 095 | nao_avaliado | apps | 16.70s | APP_OPEN | Abre o Opera... não, abre a Calculadora. |
| 096 | falhou | apps | 4.29s | MAXIMIZE_WINDOW | Fecha a Calculadora... quer dizer, maximiza ela. |
| 097 | falhou | browser | 15.85s | APP_OPEN | Abre a Wikipédia, não, melhor o Prime Video. |
| 098 | nao_avaliado | browser | 1.75s | SEARCH | Pesquisa Python... pera, não pesquisa nada. |
| 099 | falhou | iot | 0.06s | sem intent | Liga a lâmpada... não, deixa desligada. |
| 100 | alerta | musica | 2.35s | MEDIA_CONTROL | Pausa a música... esquece, continua tocando. |
| 101 | passou | arquivos | 1.75s | CREATE_FILE | Cria um arquivo chamado erro.txt... não, chama correcao.txt. |
| 102 | nao_avaliado | conversa | 1.02s | sem intent | Escreve banana no correcao.txt... quer dizer, escreve maçã. |
| 103 | nao_avaliado | arquivos | 2.80s | DELETE_ITEM | Apaga o correcao.txt... não apaga. |
| 104 | nao_avaliado | conversa | 0.99s | sem intent | Onde fica o correcao.txt? |
| 105 | nao_avaliado | apps | 5.60s | APP_OPEN | Abre a Calculadora. |
| 106 | nao_avaliado | apps | 3.33s | APP_OPEN | Abre o Opera. |
| 107 | nao_avaliado | apps | 8.09s | CLOSE_APP | Fecha ele. |
| 108 | nao_avaliado | conversa | 3.56s | sem intent | Qual deles você fechou? |
| 109 | nao_avaliado | apps | 2.91s | APP_OPEN | Abre a Calculadora de novo. |
| 110 | passou | apps | 1.32s | ORGANIZAR_DESKTOP | Coloca ela na direita. |
| 111 | passou | apps | 4.17s | ORGANIZAR_DESKTOP | Coloca o outro na esquerda. |
| 112 | passou | apps | 4.11s | MAXIMIZE_WINDOW | Maximiza ele. |
| 113 | falhou | conversa | 2.83s | sem intent | Qual está em foco agora? |
| 114 | passou | browser | 5.12s | OPEN_URL | Abre a Wikipédia. |
| 115 | nao_avaliado | browser | 3.09s | OPEN_URL | Abre o Prime Video. |
...
| 119 | nao_avaliado | browser | 3.63s | CLOSE_TAB | Fecha essa. |
| 120 | passou | browser | 2.48s | OPEN_URL | Abre a Wikipédia de novo. |
| 121 | nao_avaliado | browser | 2.63s | SEARCH | Pesquisa documentação do Python. |
| 122 | nao_avaliado | browser | 1.11s | SEARCH | Abre o primeiro resultado. |
| 123 | falhou | conversa | 7.95s | sem intent | Resume isso. |
| 124 | nao_avaliado | conversa | 2.00s | sem intent | E a anterior? |
| 125 | nao_avaliado | conversa | 1.89s | sem intent | Volta. |
| 126 | falhou | conversa | 1.01s | sem intent | Resume agora. |
| 127 | nao_avaliado | conversa | 1.41s | sem intent | Se o Opera estiver aberto, só me diga; não mexa nele. |
...
| 130 | nao_avaliado | apps | 3.65s | LIST_WINDOWS | A Calculadora está aberta? |
...
| 135 | nao_avaliado | iot | 7.69s | IOT_STATUS | Se a lâmpada estiver ligada, só me diga o estado. |
| 136 | nao_avaliado | iot | 7.25s | IOT_STATUS | Como está a lâmpada do quarto? |
| 137 | nao_avaliado | conversa | 4.21s | sem intent | Se ela já estiver desligada, não mande desligar de novo. |
| 138 | nao_avaliado | iot | 18.51s | IOT_CONTROL | Desliga a lâmpada do quarto. |
| 139 | alerta | iot | 18.52s | IOT_CONTROL | Desliga ela de novo. |
| 140 | nao_avaliado | iot | 7.50s | IOT_STATUS | Como ela ficou? |
| 141 | nao_avaliado | apps | 4.71s | APP_OPEN, ORGANIZAR_DESKTOP | Abre a Calculadora e coloca ela na direita. |
| 142 | nao_avaliado | apps | 4.65s | APP_OPEN, ORGANIZAR_DESKTOP | Abre o Opera e coloca ele na esquerda. |
| 143 | passou | apps | 4.24s | MAXIMIZE_WINDOW, APP_OPEN | Maximiza a Calculadora e depois volta o foco para o Opera. |
| 144 | passou | browser | 3.73s | OPEN_URL, SEARCH, FILE_OPEN_RESULT | Abre a Wikipédia, pesquisa documentação oficial do Python e abre o primeiro resultado. |
| 145 | falhou | browser | 120.02s | sem intent | Volta para a aba anterior e depois me diz qual aba está aberta. |
