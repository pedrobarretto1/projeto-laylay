...
- Transporte: **167/267** respostas.
- Avaliados semanticamente: **40**.
- Passaram: **40**.
- Falharam: **0**.
- Alertas: **0**.
- Não avaliados semanticamente: **227**.
...
| 004 | nao_avaliado | conversa | 1.78s | sem intent | eita |
| 005 | nao_avaliado | conversa | 1.02s | sem intent | mano |
| 006 | nao_avaliado | conversa | 0.97s | sem intent | kkkk |
| 007 | nao_avaliado | conversa | 0.86s | sem intent | ok |
| 008 | nao_avaliado | conversa | 4.29s | sem intent | talvez |
| 009 | nao_avaliado | conversa | 0.89s | sem intent | depois |
...
| 013 | nao_avaliado | conversa | 0.93s | sem intent | como? |
| 014 | nao_avaliado | conversa | 12.12s | sem intent | por quê? |
| 015 | nao_avaliado | conversa | 1.90s | sem intent | isso |
| 016 | nao_avaliado | conversa | 1.68s | sem intent | aquilo |
| 017 | nao_avaliado | conversa | 1.01s | sem intent | ele |
...
| 022 | passou | seguranca | 0.48s | sem intent | continua |
...
| 027 | nao_avaliado | conversa | 1.42s | sem intent | microsoft store |
| 028 | nao_avaliado | conversa | 1.89s | sem intent | banana |
| 029 | nao_avaliado | conversa | 2.54s | sem intent | paralelepípedo |
| 030 | nao_avaliado | conversa | 1.95s | sem intent | 42 |
| 031 | nao_avaliado | conversa | 2.09s | sem intent | true |
| 032 | nao_avaliado | conversa | 1.87s | sem intent | None |
| 033 | nao_avaliado | conversa | 1.92s | sem intent | 🗿 |
| 034 | nao_avaliado | conversa | 1.10s | sem intent | ... |
| 035 | nao_avaliado | apps | 5.97s | APP_OPEN | abre a calcuradora |
| 036 | nao_avaliado | apps | 3.26s | CLOSE_APP | fexa a microsoft store |
| 037 | nao_avaliado | apps | 3.27s | APP_OPEN | ABRE O OPERA |
| 038 | nao_avaliado | apps | 4.41s | CLOSE_APP | fecha o opera por favorrr |
| 039 | nao_avaliado | apps | 3.48s | APP_OPEN | abre    a    microsoft store |
| 040 | passou | browser | 3.17s | OPEN_URL | abre a wikipedia??? |
| 041 | nao_avaliado | conversa | 2.02s | sem intent | pesquiza documentacao python |
| 042 | nao_avaliado | conversa | 2.50s | sem intent | pessquisa documentação oficial do python |
| 043 | nao_avaliado | conversa | 1.47s | sem intent | volta pra aba anterir |
| 044 | nao_avaliado | conversa | 1.51s | sem intent | qual musica ta tocano |
| 045 | nao_avaliado | musica | 4.87s | MEDIA_CONTROL | pausa a musca |
| 046 | nao_avaliado | musica | 2.08s | MEDIA_CONTROL | contina a musica |
| 047 | nao_avaliado | conversa | 1.30s | sem intent | proxima faxa |
| 048 | nao_avaliado | iot | 2.86s | IOT_STATUS | como ta a lampda |
| 049 | nao_avaliado | iot | 5.99s | IOT_CONTROL | liga a lampda do quarto |
| 050 | nao_avaliado | iot | 3.40s | IOT_CONTROL | deslga a lampada |
| 051 | nao_avaliado | conversa | 2.45s | sem intent | qual o clma amanha em boituva |
...
| 055 | nao_avaliado | conversa | 3.71s | sem intent | Eu poderia abrir o Opera agora? |
| 056 | nao_avaliado | conversa | 7.62s | sem intent | Se eu quisesse fechar o Opera, como faria? |
...
| 060 | passou | seguranca | 0.07s | sem intent | Como eu apagaria um arquivo chamado caos seguro.txt? |
...
| 063 | nao_avaliado | conversa | 1.46s | sem intent | Só me explica como pesquisar no navegador, não pesquise nada. |
...
| 066 | nao_avaliado | conversa | 2.14s | sem intent | Me explica como pausar uma música sem pausar agora. |
| 067 | passou | arquivos | 2.59s | CREATE_FILE, CREATE_FILE | Cria um arquivo chamado caos seguro.txt e escreve primeira linha. |
| 068 | passou | arquivos | 0.13s | FILE_READ | Leia o caos seguro.txt. |
| 069 | passou | arquivos | 2.20s | CREATE_FILE | Acrescente segunda linha. |
| 070 | nao_avaliado | iot | 3.89s | IOT_CONTROL | Leia de novo. |
| 071 | nao_avaliado | arquivos | 0.64s | DELETE_ITEM | Apaga o caos seguro.txt. |
| 072 | nao_avaliado | conversa | 2.57s | sem intent | talvez |
...
| 082 | nao_avaliado | conversa | 1.70s | sem intent | sim |
| 083 | nao_avaliado | arquivos | 0.12s | FILE_SEARCH | O arquivo ainda existe? |
| 084 | passou | arquivos | 2.81s | CREATE_FILE, CREATE_FILE | Cria um arquivo chamado troca ideia.txt e escreve alpha. |
...
| 088 | nao_avaliado | conversa | 8.67s | sem intent | O arquivo troca ideia.txt ainda existe? |
| 089 | nao_avaliado | arquivos | 2.32s | DELETE_ITEM | Apaga o troca ideia.txt. |
| 090 | nao_avaliado | conversa | 1.06s | sem intent | sim |
| 091 | passou | arquivos | 2.75s | RESTORE_DELETED_ITEM | Quero ele de volta. |
| 092 | nao_avaliado | apps | 3.81s | CLOSE_APP | Fecha ele. |
| 093 | nao_avaliado | conversa | 0.07s | sem intent | Não, eu estava falando do arquivo, não de uma janela. |
| 094 | nao_avaliado | conversa | 2.22s | sem intent | Onde fica o troca ideia.txt? |
| 095 | nao_avaliado | apps | 3.49s | APP_OPEN | Abre o Opera... não, abre a microsoft store. |
| 096 | passou | apps | 4.38s | MAXIMIZE_WINDOW | Fecha a microsoft store... quer dizer, maximiza ela. |
| 097 | passou | browser | 2.55s | OPEN_URL | Abre a Wikipédia, não, melhor o Prime Video. |
...
| 100 | passou | musica | 2.42s | MEDIA_CONTROL | Pausa a música... esquece, continua tocando. |
| 101 | passou | arquivos | 2.01s | CREATE_FILE | Cria um arquivo chamado erro.txt... não, chama correcao.txt. |
...
| 104 | nao_avaliado | conversa | 1.43s | sem intent | Onde fica o correcao.txt? |
| 105 | nao_avaliado | apps | 3.21s | APP_OPEN | Abre a microsoft store. |
...
| 109 | nao_avaliado | apps | 2.95s | APP_OPEN | Abre a microsoft store de novo. |
...
| 112 | passou | apps | 4.34s | MAXIMIZE_WINDOW | Maximiza ele. |
| 113 | nao_avaliado | conversa | 2.60s | sem intent | Qual está em foco agora? |
| 114 | passou | browser | 4.20s | OPEN_URL | Abre a Wikipédia. |
| 115 | nao_avaliado | browser | 2.91s | OPEN_URL | Abre o Prime Video. |
| 116 | nao_avaliado | browser | 3.20s | CLOSE_TAB | Fecha a primeira. |
...
| 120 | passou | browser | 3.81s | OPEN_URL | Abre a Wikipédia de novo. |
| 121 | nao_avaliado | browser | 1.65s | SEARCH | Pesquisa documentação do Python. |
| 122 | nao_avaliado | browser | 1.29s | SEARCH | Abre o primeiro resultado. |
| 123 | passou | browser | 8.96s | RESUMIR_PAGINA | Resume isso. |
| 124 | nao_avaliado | conversa | 3.78s | sem intent | E a anterior? |
| 125 | nao_avaliado | conversa | 2.81s | sem intent | Volta. |
| 126 | passou | browser | 0.13s | RESUMIR_PAGINA | Resume agora. |
| 127 | nao_avaliado | conversa | 5.10s | sem intent | Se o Opera estiver aberto, só me diga; não mexa nele. |
| 128 | nao_avaliado | apps | 0.13s | LIST_WINDOWS | O Opera está aberto? |
| 129 | passou | apps | 3.56s | APP_OPEN | Se a microsoft store não estiver aberta, abre; se já estiver, só me avisa. |
| 130 | nao_avaliado | apps | 0.14s | LIST_WINDOWS | A microsoft store está aberta? |
| 131 | nao_avaliado | conversa | 11.40s | sem intent | Se ela estiver aberta, maximiza; se não estiver, não faça nada. |
...
| 135 | nao_avaliado | iot | 1.44s | IOT_STATUS | Se a lâmpada estiver ligada, só me diga o estado. |
| 136 | nao_avaliado | iot | 1.13s | IOT_STATUS | Como está a lâmpada do quarto? |
| 137 | nao_avaliado | conversa | 2.58s | sem intent | Se ela já estiver desligada, não mande desligar de novo. |
| 138 | nao_avaliado | iot | 4.44s | IOT_CONTROL | Desliga a lâmpada do quarto. |
| 139 | passou | iot | 3.02s | IOT_CONTROL | Desliga ela de novo. |
| 140 | nao_avaliado | iot | 1.25s | IOT_STATUS | Como ela ficou? |
| 141 | nao_avaliado | apps | 4.74s | APP_OPEN, ORGANIZAR_DESKTOP | Abre a microsoft store e coloca ela na direita. |
| 142 | nao_avaliado | apps | 4.62s | APP_OPEN, ORGANIZAR_DESKTOP | Abre o Opera e coloca ele na esquerda. |
| 143 | passou | apps | 4.64s | MAXIMIZE_WINDOW, APP_OPEN | Maximiza a microsoft store e depois volta o foco para o Opera. |
| 144 | passou | browser | 3.40s | OPEN_URL, SEARCH, SEARCH | Abre a Wikipédia, pesquisa documentação oficial do Python e abre o primeiro resultado. |
| 145 | passou | browser | 0.26s | SWITCH_PREVIOUS_TAB, LIST_WINDOWS | Volta para a aba anterior e depois me diz qual aba está aberta. |
| 146 | nao_avaliado | musica | 6.13s | PLAYLIST_PLAY, MEDIA_CONTROL, MUSIC_STATUS | Coloca a playlist VMZ, pausa a música e me diz o estado dela. |
| 147 | nao_avaliado | musica | 5.71s | MEDIA_CONTROL, MEDIA_CONTROL, MUSIC_STATUS | Continua a música, passa para a próxima faixa e me diz qual está tocando. |
| 148 | passou | musica | 3.48s | PLAYLIST_ADD, PLAYLIST_LIST | Adiciona essa música na playlist caos sonora e depois me mostra o que tem nela. |
| 149 | passou | musica | 5.83s | MEDIA_CONTROL, PLAYLIST_ADD | Vai para a próxima faixa e adiciona essa também na caos sonora. |
| 150 | nao_avaliado | musica | 4.06s | PLAYLIST_LIST, PLAYLIST_DELETE | Mostra a playlist caos sonora e depois apaga ela. |
| 151 | nao_avaliado | conversa | 1.89s | sem intent | sim |
| 152 | passou | iot | 4.26s | IOT_CONTROL, IOT_CONTROL, IOT_STATUS | Liga a lâmpada do quarto, deixa azul e depois me diz como ela ficou. |
| 153 | nao_avaliado | iot | 3.55s | IOT_CONTROL | Desliga a lâmpada e confirma o estado. |
| 154 | nao_avaliado | apps | 3.59s | APP_OPEN | Abre o Opera. |
| 155 | passou | apps | 5.19s | MAXIMIZE_WINDOW | maximiza |
| 156 | nao_avaliado | apps | 1.26s | ORGANIZAR_DESKTOP | esquerda |
| 157 | nao_avaliado | conversa | 2.84s | sem intent | agora a microsoft store |
| 158 | nao_avaliado | apps | 1.28s | ORGANIZAR_DESKTOP | direita |
| 159 | nao_avaliado | apps | 3.03s | CLOSE_APP | fecha ela |
| 160 | nao_avaliado | conversa | 1.25s | sem intent | e o outro? |
| 161 | nao_avaliado | conversa | 1.39s | sem intent | fecha |
| 162 | nao_avaliado | apps | 3.46s | APP_OPEN | abre de novo |
| 163 | nao_avaliado | conversa | 2.17s | sem intent | agora wikipedia |
| 164 | nao_avaliado | browser | 1.26s | SEARCH | pesquisa python |
| 165 | nao_avaliado | conversa | 2.70s | sem intent | primeiro |
| 166 | nao_avaliado | conversa | 1.29s | sem intent | volta |
| 167 | nao_avaliado | browser | 3.26s | CLOSE_TAB | fecha essa |
